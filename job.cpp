#include "job.h"
#include "Battle.h"
SwordMan::SwordMan(std::string _name, int _maxHp, int _strength, int _defence, int _x, int _y,int _crits, int _level, int _experience, int _coin):RpgPerson(_name,_maxHp,_strength,_defence,_x,_y,_crits,_level,_experience,_coin){}

Thief::Thief(std::string _name, int _maxHp, int _strength, int _defence, int _x, int _y,int _crits, int _level, int _experience, int _coin):RpgPerson(_name,_maxHp,_strength,_defence,_x,_y,_crits,_level,_experience,_coin){}

Magician::Magician(std::string _name, int _maxHp, int _strength, int _defence, int _x, int _y,int _crits, int _level, int _experience, int _coin):RpgPerson(_name,_maxHp,_strength,_defence,_x,_y,_crits,_level,_experience,_coin){}
...
std::string SwordMan::getJob(){
	return "SwordMan";
}
std::string Thief::getJob(){
	return "Thief";
}
std::string Magician::getJob(){
	return "Magician";
}
